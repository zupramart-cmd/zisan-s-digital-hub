...
import { Mail, Linkedin, Github, Facebook, Youtube, MessageCircle, Send, ArrowUp, Shield, Loader2, CheckCircle } from 'lucide-react';
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              {language === 'en' ? 'Please wait a moment' : 'অনুগ্রহ করে অপেক্ষা করুন'}
            </p>
          </div>
        </div>,
        {
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 bg-background border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none text-sm disabled:opacity-50"
              />
              <button
                type="submit"
                disabled={isSubscribing}
              ...
              >
                {isSubscribing ? <Loader2 size={16} className="animate-spin" /> : <Send size={16} />}
              </button>
            </form>
            {/* Social Icons */}
