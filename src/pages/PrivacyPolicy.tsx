...
import { Shield, Camera, Type, Copyright, Scale, AlertTriangle, FileText, Globe, Loader2 } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchIp = async () => {
      try {
        ...
        setIpAddress(language === 'en' ? 'Unable to detect' : 'সনাক্ত করা যায়নি');
      } finally {
    ...
    <main className="pt-20 pb-16 min-h-screen bg-background">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          {/* Visitor IP Display */}
          <div className="mt-4 p-4 bg-accent/50 border border-border rounded-xl flex items-center gap-3">
              ...
              <p className="text-sm text-muted-foreground">
                {isLoadingIp ? (
                  <span className="flex items-center gap-2">
                    ...
                    {language === 'en' ? 'Detecting...' : 'সনাক্ত করা হচ্ছে...'}
                  </span>
                ) : ipAddress}
              </p>
            </div>
        ...
        {/* Contact Section */}
        <div className="mt-8 p-6 bg-accent/30 rounded-xl text-center">
